...
export const useMiddleware = useContext.middleware.bind(useContext);
export const useCommand = useContext.command.bind(useContext);
...
export const setOptions = useContext.options.bind(useContext);
