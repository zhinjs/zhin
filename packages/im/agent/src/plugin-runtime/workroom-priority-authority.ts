...
export class GenerationWorkroomPriorityAuthority implements WorkroomPriorityAuthorityPort {
  readonly #resolve: () => WorkroomPriorityAuthorityPort | undefined;

  constructor(resolve: () => WorkroomPriorityAuthorityPort | undefined) {
...
export class CatalogWorkroomPriorityAuthority implements WorkroomPriorityAuthorityPort {
  readonly #catalog: Pick<WorkroomCatalog, 'read'>;

  constructor(catalog: Pick<WorkroomCatalog, 'read'>) {
