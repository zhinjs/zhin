...
```bash
pnpm --filter @zhin.js/next-config-yaml test
pnpm --filter @zhin.js/next-config-yaml build
pnpm --filter @zhin.js/next-config-yaml check:size
```
