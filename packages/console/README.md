...
| [page](./page/) | `@zhin.js/page` | `pages/*/index.ts|tsx` 约定式 Feature provider |
| [layout](./layout/) | `@zhin.js/layout` | `pages/nav/index.tsx` / `pages/footer/index.tsx` Layout Feature provider |
