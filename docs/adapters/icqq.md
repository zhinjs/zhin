...
<!-- sync-adapter-docs:sha256=4cf3650aefe67895 -->
...
完整说明与指令表见仓库文档：[docs/advanced/ai.md](https://github.com/zhinjs/zhin/tree/main/plugins/docs/advanced/ai.md)（锚点：`#icqq-bash-exec`、`#owner-approve-commands`）。
