...
Stable minimal-bot 已成为首个完整迁移项目；下一阶段迁移 Sandbox/Host 与平台 Plugin，并补发布
manifest artifact。
...
| 旧代码迁移 | 4–8 | 发布 manifest artifact；Sandbox/Host；Adapters；services/utils；其余 examples 与正式入口切换 |
