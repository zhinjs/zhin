---
title: "记忆、上下文与压缩"
translation_source_body_sha256: d56772bb026b40a80e7f46f744df6ddbbcbe8f9a7c8955b00f26c2c15603559d
---
...
启动文件定义了代理的核心身份和操作准则。这些文件通常在项目骨架搭建或实例初始化时加载。

### 核心启动文件
*   **SOUL.md**：定义了代理的性格、价值观和工作方式。它强调行动导向的行为和简洁的沟通。
