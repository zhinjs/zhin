import { c as clear$2 } from "./chunk-RYQCIY6F.D9fsE4o5.js";
import { ap as markers_default, aq as clear2, ar as clear, as as clear$1, l as log, c as getConfig2, aj as insertNode, ai as insertCluster, ak as positionNode, aw as insertEdge, ay as insertEdgeLabel, G as getConfig, av as getSubGraphTitleMargins, az as edgeLabels, u as utils_default, aA as terminalLabels, _ as __name, aB as markerOffsets } from "./app.js";
...
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await import("./sizeCapture-X5ZJPWSS.DT3lvVJZ.js");
...
function assignCoordinates(ordered, gWithDummies, opts) {
  ...
  const getWidth = /* @__PURE__ */ __name((id) => {
    var _a;
    return ((_a = getNode(id)) == null ? void 0 : _a.width) ?? 0;
  }, "getWidth");
  const getHeight = /* @__PURE__ */ __name((id) => {
    var _a;
...
function routeEdgesOrthogonal(data, direction) {
  ...
  const edgeHasLabelNode = /* @__PURE__ */ __name((edgeIdx) => {
    var _a2;
