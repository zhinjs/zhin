...
import { g as getDiagramElement } from "./chunk-XXDRQBXY.C_xcOgTI.js";
import { s as setupViewPortForSVG } from "./chunk-VR4S4FIN.B29y2Pyx.js";
import { _ as __name, l as log, c as getConfig2, q as getRegisteredLayoutAlgorithm, r as render, u as utils_default, d as select, A as purify, b as setAccTitle, a as getAccTitle, s as setAccDescription, g as getAccDescription, t as setDiagramTitle, v as getDiagramTitle, k as common_default, B as clear, z as getEdgeId, i as sanitizeText, a9 as parseGenericTypes } from "./app.js";
import { c as createTooltip } from "./chunk-32BRIVSS.tS_IqJod.js";
var parser = (function() {
...
var ClassDB = (_b = class {
  ...
  addNamespace(id, label) {
    const qualifiedId = _b.resolveQualifiedId(id, this.namespaceStack);
    ...
    const parts = qualifiedId.split(".");
    const ancestorIds = _b.getAncestorIds(qualifiedId);
  ...
  getData() {
    ...
    const edges = [];
    const config = getConfig2();
    const hierarchical = ((_a2 = config.class) == null ? void 0 : _a2.hierarchicalNamespaces) ?? true;
    ...
    for (const note of this.notes.values()) {
      ...
      nodes.push(noteNode);
      const noteClassId = (_b2 = this.classes.get(note.class)) == null ? void 0 : _b2.id;
      if (noteClassId) {
        const edge = {
