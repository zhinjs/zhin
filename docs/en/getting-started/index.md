...
Change the reply in `commands/hello/index.ts`, save it, and send `/hello` again. New requests use the new generation; an in-flight request keeps its original snapshot.
