...
modules.forEach((p) => {
    ...
    task_queue.push(
        fs.outputFile(root("lib", `${importBinding}.js`), re_export_legacy_lib_cjs(importBinding), {
            encoding: "utf-8",
        }),
    );
...
task_queue.push(
    ...
    fs.outputJSON(root("lib", "package.json"), { type: "commonjs" }, { spaces: 4 }),
...
function re_export_legacy_lib_cjs(importBinding) {
    return `module.exports = require("legacy-swc-helpers/lib/${importBinding}.js")`;
}
