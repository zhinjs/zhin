...
[![Codecov](https://img.shields.io/codecov/c/github/zhinjs/zhin?style=flat-square)](https://codecov.io/gh/zhinjs/zhin)
[![dm](https://shields.io/npm/dm/zhin)](https://www.npmjs.com/package/zhin)
[![build status](https://github.com/zhinjs/zhin/actions/workflows/publish.yml/badge.svg?branch=main)](https://github.com/zhinjs/zhin/actions/workflows/publish.yml)
...
Zhin 完全使用 [MIT](./LICENSE) 协议开源，维护良好的开源生态从我做起 (*>ω<)φ
...
### 鸣谢
1. [oitq](https://github.com/oitq/oitq) (zhin 前身，因过于臃肿，索性开新坑)
2. [icqq](https://github.com/icqqjs/icqq) (zhin 作者维护的[oicq](https://github.com/takayama-lily/oicq)一个分支)提供本内置适配器基础功能
3. [Koishi](https://github.com/koishijs/koishi) (抄了不少~~被抓现行~~，留名保命) zhin的参考答案，本想直接用，奈何太重了，弃坑谋发展
