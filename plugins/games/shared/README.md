...
```typescript
import { buildChoiceKeyboard, parseChoicePayload } from '@zhin.js/game-shared';
...
```typescript
import { buildGridKeyboard, parseGridPayload, parseCellButtonId } from '@zhin.js/game-shared';
