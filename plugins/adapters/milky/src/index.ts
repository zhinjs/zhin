 ...
 */
import { usePlugin, type Plugin, type Context, createSceneManagementTools, registerDefaultScenePlatformPermitChecker, type ToolFeature } from 'zhin.js';
import type { Router } from '@zhin.js/host-router';
import { MilkyAdapter } from './adapter.js';
import type { ISceneManagement } from 'zhin.js';
