...
import listCommand from '../commands/satori/endpoint/list/index.js';
import addCommand from '../commands/satori/endpoint/add/[id]/index.js';
import removeCommand from '../commands/satori/endpoint/remove/[id]/index.js';
