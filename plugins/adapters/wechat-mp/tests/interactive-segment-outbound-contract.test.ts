/**
 * wechat-mp interactive segment outbound contract
 */
...
describe('wechat-mp interactive segment outbound contract', () => {
  it('declares interactivePolicy', () => {
    assertInteractiveOutboundContract(WeChatMPAdapter);
  });
});
