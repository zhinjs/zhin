...
import listCommand from '../commands/onebot12/endpoint/list/index.js';
import addCommand from '../commands/onebot12/endpoint/add/[id]/index.js';
import removeCommand from '../commands/onebot12/endpoint/remove/[id]/index.js';
