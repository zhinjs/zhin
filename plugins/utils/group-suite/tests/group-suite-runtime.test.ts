...
import checkinQueryTool from '../tools/checkin_query/index.ts';
import checkinRankTool from '../tools/checkin_rank/index.ts';
import statsQueryTool from '../tools/stats_query/index.ts';
import statsUserTool from '../tools/stats_user/index.ts';
import groupAnnounceTool from '../tools/group_announce/index.ts';
import {
  addKeyword,
  listKeywords,
  matchKeyword,
