...
import mypointsCommand from '../commands/mypoints/index.ts';
import rankCommand from '../commands/rank/index.ts';
import keywordList from '../commands/keyword-list/index.ts';
import keywordAdd from '../commands/keyword-add/[keyword]/index.ts';
import keywordMiddleware from '../middlewares/keyword-reply/index.ts';
import teachCommand from '../commands/teach/index.ts';
import teachListCommand from '../commands/teach-list/[[page]]/index.ts';
import forgetCommand from '../commands/forget/index.ts';
import teachMiddleware from '../middlewares/teach-reply/index.ts';
import statsCommand from '../commands/stats/index.ts';
import mystatsCommand from '../commands/mystats/index.ts';
import statsMiddleware from '../middlewares/stats-count/index.ts';
import checkinQueryTool from '../skills/checkin/tools/checkin_query/index.ts';
import checkinRankTool from '../skills/checkin/tools/checkin_rank/index.ts';
import statsQueryTool from '../skills/group-daily-analysis/tools/stats_query/index.ts';
import statsUserTool from '../skills/group-daily-analysis/tools/stats_user/index.ts';
import groupAnnounceTool from '../skills/group-daily-analysis/tools/group_announce/index.ts';
import {
  addKeyword,
  listKeywords,
  matchKeyword,
