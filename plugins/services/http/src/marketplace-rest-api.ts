...
export function registerMarketplacePubRoutes(table: RouteTable): void {
  registerFetchRoute(table, "GET", "/pub/marketplace/search", async (ctx: RouterContext) => {
  ...
  registerFetchRoute(table, "GET", "/pub/marketplace/detail/:name+", async (ctx: RouterContext) => {
...
export function registerMarketplaceUpdatesRoute(
  ...
  registerFetchRoute(table, "GET", `${base}/marketplace/updates`, async (ctx: RouterContext) => {
    try {
...
export function registerMarketplaceRoutes(
  ...
  registerMarketplacePubRoutes(table);
  registerMarketplaceUpdatesRoute(table, base, getRoot);
}
