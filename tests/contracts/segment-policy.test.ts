...
const EXPECTED: Record<string, AdapterDefinition['segments']> = {
  ...
  email: { outboundMedia: ['url', 'path'], interactive: 'text' },
  github: { outboundMedia: ['url'], interactive: 'text' },
  icqq: { outboundMedia: ['base64', 'url', 'upload'], interactive: 'text' },
  ...
  napcat: { outboundMedia: ['url', 'base64'], interactive: 'text' },
  ...
  sandbox: { outboundMedia: ['base64'], interactive: 'native' },
  satori: { outboundMedia: ['url', 'base64'], interactive: 'text' },
  slack: { outboundMedia: ['url', 'upload'], interactive: 'native' },
  telegram: { outboundMedia: ['url', 'upload'], interactive: 'native' },
  'wechat-mp': { outboundMedia: ['url', 'upload'], interactive: 'text' },
  wecom: { outboundMedia: ['url', 'upload'], interactive: 'text' },
  'weixin-ilink': { outboundMedia: ['base64', 'url', 'upload'], interactive: 'text' },
};
